...
//agregar un boton de cargar datos y otro de refrescar datos o un contador donde
//aparesca el tiempo del token
...
export const GET: APIRoute = async ({ request }) => {
  try {
    ...
    const artists: Artists = (await getFollowedArtists(access_token)).artists
      .items;
    return new Response(
      JSON.stringify({
        message: "exito",
...
const getFollowedArtists = async (token: string | null) => {
  try {
